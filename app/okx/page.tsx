...
export default function OKXPage() {
  return (
    <>
      <FloatingCTA exchangeName="OKX" inviteCode="CRMBAO" registerLink="https://www.afibbjgrubxx.com/join/CRMBAO" />
      <BottomBar />
            ...
            <div className="flex items-start gap-6 mb-8">
              ...
              <div className="relative">
                <div className="h-24 w-24 rounded-[24px] overflow-hidden shadow-2xl flex items-center justify-center">
                  <img src="/images/okx.png" alt="OKX" className="w-full h-full object-cover" />
                </div>
                {/* 角标 */}
              ...
              <div className="flex-1">
                ...
                <div className="flex gap-3">
                  ...
                  >
                    <a
                      href="https://www.afibbjgrubxx.com/join/CRMBAO"
                      target="_blank"
